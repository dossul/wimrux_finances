/**
 * WIMRUX FINANCES — Edge Function: ingest-image-payment
 * Ingest Image Payment — Stub (à enrichir avec la logique métier réelle)
...
module.exports = async function(context) {
  ...
  try {
    ...
    return context.res.json({
      success: true,
      message: 'Ingest Image Payment — stub exécuté',
