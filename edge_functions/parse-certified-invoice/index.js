/**
 * WIMRUX FINANCES — Edge Function: parse-certified-invoice
 * Parse Certified Invoice — Stub (à enrichir avec la logique métier réelle)
...
module.exports = async function(context) {
  ...
  try {
    ...
    return context.res.json({
      success: true,
      message: 'Parse Certified Invoice — stub exécuté',
