/**
 * WIMRUX FINANCES — Edge Function: ingest-text-payment
 * Ingest Text Payment — Stub (à enrichir avec la logique métier réelle)
...
module.exports = async function(context) {
  ...
  try {
    ...
    return context.res.json({
      success: true,
      message: 'Ingest Text Payment — stub exécuté',
