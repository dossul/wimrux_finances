...
# Créer un fichier SQL sur le serveur
sql_lines = []
vars_to_set = [
...
# Écrire le fichier SQL sur le serveur
sftp = client.open_sftp()
with sftp.file('/tmp/setup_vars.sql', 'w') as f:
    f.write(sql_content)
sftp.close()

print(f"SQL file written:\n{sql_content[:500]}")

# Exécuter le SQL
stdin, stdout, stderr = client.exec_command(
    "docker exec -i appwrite-mariadb mysql -u root -p'appwrite-db-pass-2024' appwrite < /tmp/setup_vars.sql"
)
print("\nSQL execution:")
